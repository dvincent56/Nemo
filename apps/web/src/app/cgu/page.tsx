...
export const metadata: Metadata = {
  title: 'CGU · Nemo',
  description: "Conditions générales d'utilisation du circuit Nemo.",
};

// Date de dernière révision — à mettre à jour à chaque changement substantiel.
...
const SECTIONS: LegalSection[] = [
  ...
  },
  {
    id: 'acceptation',
    num: '02',
    title: 'Acceptation et modification',
    body: (
      <>
        <p>
  ...
  },
  {
    id: 'regles',
    num: '04',
    title: 'Règles de jeu et fair-play',
    body: (
      <>
        <p>
  ...
  },
  {
    id: 'abonnement',
    num: '05',
    title: 'Abonnement Mode Carrière',
    body: (
      <>
        <p>
  ...
  return (
    <SiteShell>
      <LegalLayout
        ...
        intro={
          <>
            Les règles du jeu, de l'inscription à la résiliation. Écrites pour être lisibles, pas pour se
            planquer derrière du jargon juridique.
          </>
        }
